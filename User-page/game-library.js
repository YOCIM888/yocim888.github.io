...
const gameLibraryConfig = {
  ...
  games: [
    ...
    { id: 3, name: "经典象棋", icon: "👾", file: "chinese-chess.html", category: "策略" },
    { id: 4, name: "梦幻塔防", icon: "🎯", file: "Dream-TowerDefence.html", category: "策略" },
    { id: 5, name: "冒险岛", icon: "⚔️", file: "Adventure-Island.html", category: "冒险" },
    { id: 6, name: "2048游戏", icon: "🧩", file: "2048.html", category: "益智" },
    { id: 7, name: "僵尸塔防", icon: "🎲", file: "Zombie-TowerDefence.html", category: "益智" },
    { id: 8, name: "圣职乱斗", icon: "♟️", file: "Auction-chaos.html", category: "策略" },
    { id: 9, name: "经典扑克", icon: "🃏", file: "Poker-blackjack.html", category: "卡牌" },
    { id: 10, name: "趣味消除", icon: "🎪", file: "Kill-BOX.html", category: "休闲" },
    { id: 11, name: "星际突击", icon: "🚀", file: "star-strike-forse.html", category: "动作" },
    { id: 12, name: "猎手射击", icon: "🔫", file: "Hunter-shooting.html", category: "射击" },
    { id: 13, name: "魂斗罗", icon: "🏹", file: "contra.html", category: "冒险" },
    { id: 14, name: "科幻象棋", icon: "🛸", file: "chess.html", category: "科幻" },
    { id: 15, name: "深渊吞噬", icon: "🤖", file: "abyss-devourer.html", category: "科幻" },
    { id: 16, name: "别踩白块", icon: "👽", file: "piano-tiles.html", category: "科幻" }
  ],
  itemsPerPage: 16,
  currentPage: 0,
  currentCategory: "全部"
