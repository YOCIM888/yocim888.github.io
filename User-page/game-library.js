...
const gameLibraryConfig = {
  // 游戏列表 - 根据你的实际游戏文件修改
  games: [
    { id: 1, name: "赛博刺客", icon: "🎮", file: "Resources/cycber-assassin.html", category: "动作" },
    { id: 2, name: "无尽战机", icon: "🕹️", file: "Resources/Endless-Warplane.html", category: "动作" },
    { id: 3, name: "经典象棋", icon: "👾", file: "Resources/chess.html", category: "策略" },
    { id: 4, name: "梦幻塔防", icon: "🎯", file: "Resources/war.html", category: "策略" },
    { id: 5, name: "冒险岛", icon: "⚔️", file: "Resources/maoxiandao.html", category: "冒险" },
    { id: 6, name: "2048游戏", icon: "🧩", file: "Resources/2048.html", category: "益智" },
    { id: 7, name: "绝望防线", icon: "🎲", file: "Resources/juewangfangxian.html", category: "益智" },
    { id: 8, name: "圣职乱斗", icon: "♟️", file: "Resources/SZLD.html", category: "策略" },
    { id: 9, name: "经典扑克", icon: "🃏", file: "Resources/dapai.html", category: "卡牌" },
    { id: 10, name: "趣味消除", icon: "🎪", file: "Resources/XXL.html", category: "休闲" },
    { id: 11, name: "星际突击", icon: "🚀", file: "Resources/XJTJD.html", category: "动作" },
    { id: 12, name: "未来射击", icon: "🔫", file: "Resources/SJYX.html", category: "射击" },
    { id: 13, name: "魂斗罗", icon: "🏹", file: "Resources/HDL.html", category: "冒险" },
    { id: 14, name: "科幻象棋", icon: "🛸", file: "Resources/KHXQ.html", category: "科幻" },
    { id: 15, name: "深渊吞噬", icon: "🤖", file: "Resources/SYTS.html", category: "科幻" },
    { id: 16, name: "外星格斗", icon: "👽", file: "Resources/WXGD.html", category: "科幻" }
  ],
  itemsPerPage: 16,
  currentPage: 0,
  currentCategory: "全部"
...
function goToGame(gameId) {
  ...
  if (game) {
    ...
    // 跳转到游戏页面
    // 注意：假设游戏文件在 "game/" 文件夹下
    // 如果你的文件夹结构不同，请修改此行
    window.location.href = `game/${game.file}`;
  }
}
