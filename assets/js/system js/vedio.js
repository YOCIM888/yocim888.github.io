document.addEventListener('DOMContentLoaded', function() {
    ...
    const landscapeSidebarToggle = document.getElementById('landscapeSidebarToggle');
    ...
    function init() {
        ...
        landscapeSidebarToggle.addEventListener('click', function() {
            const container = document.querySelector('.container');
            container.classList.toggle('landscape-sidebar-open');
            const isOpen = container.classList.contains('landscape-sidebar-open');
            this.querySelector('i').className = isOpen ? 'fas fa-times' : 'fas fa-bars';
            this.querySelector('.toggle-label').textContent = isOpen ? 'CLOSE' : 'PANEL';
        });
