...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function updateButtonState() {
    if (isPrimarySystem) {
      toggleBtn.querySelector('.cyber-subtext').textContent = 'ACTIVE';
      statusText.textContent = 'PRIMARY SYSTEM';
      statusLed.style.backgroundColor = '#00ff00';
      statusLed.style.boxShadow = '0 0 8px #00ff00';
    } else {
      toggleBtn.querySelector('.cyber-subtext').textContent = 'STANDBY';
      statusText.textContent = 'ALTERNATE SYSTEM';
